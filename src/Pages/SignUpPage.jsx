...
const SignUpPage = () => {
    ...
    return (
        <>
            <div className="flex pt-3 justify-center items-center min-h-screen bg-gray-100 px-4 sm:px-6 lg:px-8 py-8">
                <ToastContainer />
                <form className="flex flex-col items-center justify-center p-6 sm:p-8 gap-4 sm:gap-6 bg-white/80 backdrop-blur-md rounded-xl sm:rounded-2xl shadow-xl sm:shadow-2xl border border-gray-200 w-full max-w-md transition-all hover:scale-[1.01]" onSubmit={HandleSubmit}>
                    <h2 className="text-xl sm:text-2xl font-bold text-blue-800 mb-4 sm:mb-7">Sign Up</h2>
                    
                    {/* Email Input */}
                    <div className="flex flex-col p-2 sm:p-3 gap-2 w-full">
                        <label className="text-sm sm:text-base text-blue-700 font-bold">
                            Enter Your Email
                        </label>
                        <input 
                            className="px-3 sm:px-4 py-2 text-sm sm:text-base bg-white/90 rounded-md shadow-sm text-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 transition w-full read-only:cursor-not-allowed read-only:bg-gray-300"
                            type="email"
                            required
                            placeholder="Enter Your Email"
                            readOnly={isOtpSent}
                    ...
                    {isOtpSent && (
                        <>
                            ...
                            <div className="flex flex-col p-2 sm:p-3 gap-2 w-full">
                                ...
                                <input 
                                    className="px-3 sm:px-4 py-2 text-sm sm:text-base bg-white/90 rounded-md shadow-sm text-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 transition w-full"
                                    type="text"
                                    required
                                    placeholder="Enter Your Name"
                                    name="name" 
                            ...
                            <div className="flex flex-col p-2 sm:p-3 gap-2 w-full">
                                ...
                                <div className="relative">
                                    <input
                                        className="px-3 sm:px-4 py-2 text-sm sm:text-base bg-white/90 rounded-md shadow-sm text-blue-800 focus:outline-none focus:ring-2 transition w-full pr-10"
                                        onChange={(e) => { HandlePasswordChange(e.target.value) }}
                                        value={password}
                                        type={showPassword ? "text" : "password"}
                                        required
                                    ...
                                    <span
                                        ...
                                        onClick={() => setShowPassword(!showPassword)}
                                    >
                                        {showPassword ? <IoMdEye size={18} className="sm:w-5" /> : <IoMdEyeOff size={18} className="sm:w-5" />}
                                    </span>
                                </div>
                                ...
                                {password && (
                                    <div className="mt-2">
                                        <p className="text-xs sm:text-sm font-medium text-gray-700 mb-1">Password must contain:</p>
                                        <ul className="text-xs space-y-1">
                                            <li className={`flex items-center ${passwordRegex.minLength.test(password) ? 'text-green-600' : 'text-red-600'}`}>
                                                {passwordRegex.minLength.test(password) ? '✓' : '✗'} At least 8 characters
                                            </li>
                    ...
                    {otpSending || signUpUser ? (
                        ...
                        <>
                            <button
                                type="submit"
                                className="px-4 py-2 w-full text-sm sm:text-base tracking-wider mt-4 bg-gradient-to-r from-[#1138b8] to-blue-600 rounded-md text-white font-medium hover:scale-105 hover:shadow-lg transition-all duration-300 cursor-pointer"
                            >
                            ...
                            <div className="text-center w-full mt-2">
                                <Link 
                                    className="text-sm sm:text-base font-bold w-full tracking-wider" 
                                    to="/login"
                                >
